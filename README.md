...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,jquery,bootstrap,js,ts,svelte,react,flutter,dart,python,fastapi,csharp,dotnet,nodejs,express,flask,mysql,mongodb,postgres,firebase,docker,git,gitlab&perline=6&theme=compact)](https://skillicons.dev)
